...
class FireStoreCheerApi {
  static final _fireStore = FirebaseFirestore.instance;

  static Query getCheersQuery(userId) {
    Query chatRoomsQuery = _fireStore
        .collection('cheerRooms')
        .doc(userId)
        .collection('cheers')
        .orderBy('time', descending: true);
    return chatRoomsQuery;
  }

  static void sendCheerMessage(
      {cheerUserId, plan, planType, senderNickname, senderUserId, type}) async {
